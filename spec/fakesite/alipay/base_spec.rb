RSpec.describe Fakesite::Alipay::Base do
  ...
  describe "#parameters" do
    ...
    it { expect(base.parameters(uri)).to eq(params) }
  end
  ...
  describe "#redirect_url" do
    ...
    it { expect(redirect_url).to eq 'https://example.com/orders/20150401000-0001?trade_status=TRADE_SUCCESS&trade_no=1441197000&notify_id=1441197000&buyer_email=&buyer_id=&exterface=create_direct_pay_by_user&notify_time=2015-09-02+20%3A30%3A00&sign=cf4e3556a7bdf61df2c197cd42f772f9&sign_type=MD5' }
